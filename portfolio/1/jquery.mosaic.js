 ...
 */
    ...
    $.Mosaic.defaults = {
        maxRowHeight: 600, // The maximum desired height of rows
        ...
        highResImagesWidthThreshold: 600, // The item width on which to start using the the provided high resolution image instead of the normal one. High resolution images are specified via the "data-high-res-image-src" or "data-high-res-background-image-url" html element properties of each item.
